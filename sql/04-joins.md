...
**Copy-paste values for Employees (AUTO_INCREMENT):**
```sql
('John Smith', 1),
('Jane Doe', 1),
('Bob Johnson', 2),
...
**Copy-paste values for Departments (AUTO_INCREMENT):**
```sql
('Sales', 'New York'),
...
**Copy-paste values for Projects (AUTO_INCREMENT):**
```sql
('Website Redesign', 1, 50000),
('Mobile App', 2, 100000),
('Recruitment', 3, 30000),
('Brand Campaign', 4, 75000);
```
