...
if __name__ == '__main__':
    ...
    # Add books
    print("Adding books...")
    book1 = add_book("Python Crash Course", "Eric Matthes", 2019, 4.5)
    book2 = add_book("Fluent Python", "Luciano Ramalho", 2015, 5.0)
    book3 = add_book("Automate the Boring Stuff", "Al Sweigart", 2015, 4.8)
    
    print(f"Added books with IDs: {book1}, {book2}, {book3}")
    ...
    eric_books = get_books_by_author("Eric Matthes")
    for book in eric_books:
        print(f"  {book['title']}")
