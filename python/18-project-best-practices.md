...
class TestCalculateSum:
    ...
    def test_sum_non_list_raises_error(self):
...
class TestCalculateAverage:
    ...
    def test_average_with_decimals(self):
        """Test average with decimal results."""
...
```python
from clean_code import calculate_average
...
```python
from clean_code import display_results
