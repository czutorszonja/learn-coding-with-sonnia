...
- **Step-by-step instructions** with commands you can copy and run
- A **practice exercise** at the end

---

## The App We'll Build Together
...
This isn't a toy — it's the same pattern used by real startups to ship their first product.
